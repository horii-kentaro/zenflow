...
const icons: Record<string, React.ReactNode> = {
  ...
  smile: <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} aria-hidden="true"><path strokeLinecap="round" strokeLinejoin="round" d="M15.182 15.182a4.5 4.5 0 01-6.364 0M21 12a9 9 0 11-18 0 9 9 0 0118 0zM9.75 9.75c0 .414-.168.75-.375.75S9 10.164 9 9.75 9.168 9 9.375 9s.375.336.375.75zm-.375 0h.008v.015h-.008V9.75zm5.625 0c0 .414-.168.75-.375.75s-.375-.336-.375-.75.168-.75.375-.75.375.336.375.75zm-.375 0h.008v.015h-.008V9.75z" /></svg>,
...
export function Sidebar() {
  ...
  return (
    <aside className="hidden lg:flex lg:flex-col lg:w-60 lg:fixed lg:inset-y-0 bg-neutral-50 border-r border-neutral-200">
      ...
      <nav aria-label="メインナビゲーション" className="flex-1 px-3 py-4 space-y-1">
        {NAV_ITEMS.map((item) => {
      ...
      {streak && streak.currentStreak > 0 && (
        <div className="px-6 py-4 border-t border-neutral-200">
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="font-medium text-neutral-700">{streak.currentStreak}日連続</span>
          </div>
        </div>
      )}
    </aside>
